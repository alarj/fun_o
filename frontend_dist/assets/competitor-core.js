...
let competitionOverlayTileLayer = null;
...
let joinCaptchaConfig = { enabled: false, v3SiteKey: "", v2SiteKey: "", v3Action: "competitor_join_preview", unavailable: false };
let joinCaptchaPending = null;
let joinRecaptchaScriptPromise = null;
let joinRecaptchaWidgetId = null;
let joinRecaptchaScriptEl = null;
let joinRecaptchaScriptLang = "";
...
function applyUiTranslations() {
  ...
  el("closeHelpBtn").textContent = tr("competitor.help.close_btn");
  ...
  el("compMapHelpBtn").title = tr("competitor.map.help_btn");
  el("compMapHelpBtn").setAttribute("aria-label", tr("competitor.map.help_btn"));
